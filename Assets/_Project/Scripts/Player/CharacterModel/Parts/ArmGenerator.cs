...
namespace CubeWorld.Player.CharacterModel.Parts
{
    ...
    internal static class ArmGenerator
    {
        ...
        public static BodyPart BuildUpperArm(CharacterPalette palette, float unit, int colorSeed)
        {
            ...
            // large que le bras, détachée visuellement de la manche verte.
            VoxelStamper.Stamp(
                grid,
        ...
        public static BodyPart BuildForearm(CharacterPalette palette, float unit, int colorSeed)
        {
            ...
            // NOTE : le futur socket "Grip" (attache d'arme/outil dans la moufle) se déclare
            // ici, ex. part.VoxelToLocal(new Vector3(3f, 1f, 3f)).
            return new BodyPart(CharacterRigDefinition.ForearmL, mesh);
        }
    }
}
